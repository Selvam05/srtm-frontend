...
export class BreakDownRegManager extends BaseService {
    ...
    findAllByMachineId(mslNo: any) {
        let mslno: any = {};
        mslno['mslno'] = mslNo;
        return this.getCallService(`${this.breakdownRegUrl}` + "/findAllByMachineId", mslno,);
    }
    ...
    breakDownPdf(mslNo: any) {
        let mslno: any = {};
        mslno['mslno'] = mslNo;
        return this.getCallService1(`${this.breakdownRegUrl}` + "/pdf", mslNo)
    }

    breakDownExcel(mslNo: any) {
        let mslno: any = {};
        mslno['mslno'] = mslNo;
        return this.getCallService1(`${this.breakdownRegUrl}` + "/excel", mslNo)
    }
}